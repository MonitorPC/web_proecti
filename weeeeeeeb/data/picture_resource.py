...
parser.add_argument('users_set_mark', required=True)
...
class PictureResource(Resource):
    def get(self, picture_id):
        ...
        return jsonify({'picture': picture.to_dict(
            only=('title', 'picture_path', 'average_mark', 'users_set_mark', 'user_id'))})
...
class PicturesListResource(Resource):
    def get(self):
        ...
        return jsonify({'picture': [item.to_dict(
            only=('title', 'picture_path', 'average_mark', 'users_set_mark', 'user_id', 'id')) for item in picture]})
    ...
    def post(self):
        ...
        picture = Picture(title=args['title'],
                          ...
                          users_set_mark=args['users_set_mark'],
